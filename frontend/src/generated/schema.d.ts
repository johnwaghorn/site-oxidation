...
export interface paths {
    ...
    "/api/teams/{id}/notifications/test/email": {
        ...
        get?: never;
        put?: never;
        post: operations["test_email_notification"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/teams/{id}/notifications/test/slack": {
        ...
        get?: never;
        put?: never;
        post: operations["test_slack_notification"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/teams/{id}/notifications/test/teams": {
        ...
        get?: never;
        put?: never;
        post: operations["test_teams_notification"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CanarySettingsResponse: {
            ...
            state: components["schemas"]["CanaryState"];
            /** Format: int64 */
            timeout_secs: number;
            url?: string | null;
        };
        /** @enum {string} */
        CanaryState: "disabled" | "unknown" | "healthy" | "degraded";
        /** @enum {string} */
...
export interface operations {
    get_settings: {
        ...
        requestBody?: never;
        responses: {
            /** @description Global canary settings and health */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["CanarySettingsResponse"];
                };
            };
    ...
    update_settings: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateCanarySettingsRequest"];
            };
        };
        responses: {
            /** @description Global canary settings updated */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Invalid canary URL or timeout */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    test_canary: {
        ...
        requestBody?: never;
        responses: {
            /** @description Canary test completed */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Settings changed while the test was running */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Canary URL is not configured */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    update_notifications: {
        ...
        responses: {
            ...
            /** @description Invalid notification settings, e.g. a malformed webhook URL or an incomplete SMTP configuration */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    test_email_notification: {
        ...
        requestBody?: never;
        responses: {
            /** @description Test email sent via the team's SMTP settings */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description SMTP is not configured for this team */
            422: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The SMTP server rejected or did not accept the test email */
            502: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    test_slack_notification: {
        ...
        requestBody?: never;
        responses: {
            /** @description Test message sent to the team's Slack webhook */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description No Slack webhook is configured for this team */
            422: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The Slack webhook rejected or did not accept the test message */
            502: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    test_teams_notification: {
        ...
        requestBody?: never;
        responses: {
            /** @description Test message sent to the team's Microsoft Teams webhook */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description No Microsoft Teams webhook is configured for this team */
            422: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The Microsoft Teams webhook rejected or did not accept the test message */
            502: {
                headers: {
                    [name: string]: unknown;
                };
